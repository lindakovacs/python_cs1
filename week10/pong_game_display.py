...
# -*- coding: utf-8 -*-
"""
Created on Sat Apr  5 16:41:46 2025
...
class PONG:
    ...
    def update_score_display(self): # Function to update the score display
        ...
        self.score_display.write(f"{self.left_player} {self.left_score} : {self.right_score} {self.right_player}", align="center", font=("Courier", 24, "normal"))
