...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar  3 01:03:22 2025
...
class PONG:
    ...
    def __init__(self):
        ...
        # Get player names
        self.left_player = input("Enter the name of the left player: ")
        self.right_player = input("Enter the name of the right player: ")
    ...
    def update_score_display(self): # Function to update the score display
        ...
        self.score_display.write(f"{self.left_player}: {self.left_score}  {self.right_player}: {self.right_score}", align="center", font=("Courier", 24, "normal"))
