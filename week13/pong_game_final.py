...
# -*- coding: utf-8 -*-
"""
Created on Sat Apr 26 14:48:15 2025
...
class PONG:
    ...
    def __init__(self):
        ...
        # Initialize turtles for game over and winner messages
        self.game_over_display = tl.Turtle()
        self.game_over_display.hideturtle()
        self.game_over_display.penup()

        self.winner_display = tl.Turtle()
        self.winner_display.hideturtle()
        self.winner_display.penup()
    ...
    def display_winner(self, message):
        ...
        self.game_over_display.goto(0, 75)
        self.game_over_display.write("GAME OVER", align="center", font=("Courier", 36, "bold"))

        # Display the winner message
        self.winner_display.clear()
        self.winner_display.color("black")
        self.winner_display.goto(0, 50)
        self.winner_display.write(message, align="center", font=("Courier", 28, "bold"))

    def reset_game(self):
        # Clear the "GAME OVER" and winner messages
        self.game_over_display.clear()
        self.winner_display.clear()
